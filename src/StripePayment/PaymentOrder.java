...
public class PaymentOrder {
    ...
    public void setZip(String zip) {
        ...
        public  Charge createCharge(String api,double ammount,String name,String cc,String exp_m,String exp_y,String cvv,String address,String city,String state,String country,String zip,String email)
    {
                        Stripe.apiKey=api;
...
chargeParams.put("customer", createClient(email, name, cc, exp_y, exp_m, cvv, address, city, state, zip, country).getId());
        try {
            ...
            Logger.getLogger(Stripe.class.getName()).log(Level.SEVERE, null, ex);
        ...
        public  Token createToken(String name,String cc,String exp_y,String exp_m,String cvv,String address,String city,String state,String zip,String country) 
    ...
    public  Customer createClient(String email,String name,String cc,String exp_y,String exp_m,String cvv,String address,String city,String state,String zip,String country)
    {
