...
public class QuizzMemberController implements Initializable {
    ...
    private void Submit(ActionEvent event) throws SQLException {
        ...
        if(rbHobbies1.isSelected()){ reponse = "Oui"; rbHobbies1.setSelected(false);}
        if(rbHobbies2.isSelected()){ reponse = "Non"; rbHobbies1.setSelected(false);}
        listReponses.add(new Reponse(hobbieQ1.getText(), reponse, "Hobies", id));
        
        if(rbHobbies3.isSelected()){ reponse = "Oui"; rbHobbies4.setSelected(false);}
        if(rbHobbies4.isSelected()){ reponse = "Non"; rbHobbies3.setSelected(false);}
